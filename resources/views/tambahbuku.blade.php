...
<html lang="en">
  <head>
    ...
    <title>Tambah Buku MaxiSmart </title>
    <!-- plugins:css -->
              ...
              <div class="grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/buku/create" method="post" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_buku') is-invalid @enderror" id="nama_buku" name="nama_buku" placeholder="Nama Buku" value="{{ old('nama_buku') }}">
                        @error('nama_buku')
                          <div class=" invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('deskripsi_buku') is-invalid @enderror" id="deskripsi_buku" name="deskripsi_buku" placeholder="Deskripsi Buku" value="{{ old('deskripsi_buku') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('jumlah_buku') is-invalid @enderror" id="jumlah_buku" placeholder="Jumlah Buku" name="jumlah_buku" value="{{ old('jumlah_buku') }}">
                        @error('jumlah_buku')
                          <div class=" invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
